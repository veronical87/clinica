...
public class ModificarTipoOperacion extends javax.swing.JDialog {
    Connection cn;
    ConexionMySQL cm=new ConexionMySQL();
    CallableStatement cmd;
    ClaseTipoOperaciones operacion=new ClaseTipoOperaciones();
    public ModificarTipoOperacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
int IDROL,idtipoOperacion,IDCategoria;
    ...
    private void buttonActionGUARDARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionGUARDARActionPerformed
        if(nom.getText().equals("") || jComboBoxCategoriaTipo.getModel().getSelectedItem().equals("")){
            ...
            if(IDCategoria==0){
              BuscarIDCategoriaTipo(nombre);
            }
            operacion.ModificarTipoOperacion(idtipoOperacion,IDCategoria,nombre);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarTipoOperacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarTipoOperacion dialog = new ModificarTipoOperacion(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JComboBox jComboBoxCategoriaTipo;
