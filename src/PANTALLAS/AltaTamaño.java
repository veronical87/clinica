...
public class AltaTamaño extends javax.swing.JDialog{
    Connection cn;
    ConexionMySQL cm=new ConexionMySQL();
    CallableStatement cmd;
    ClaseTamanos tam=new ClaseTamanos();
    public AltaTamaño(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2), "DATOS TAMAÑOS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelRectTranslucido1, javax.swing.GroupLayout.PREFERRED_SIZE, 350, Short.MAX_VALUE)
        );
...
int idrol;
    ...
    private void buttonActionGUARDARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionGUARDARActionPerformed
        if(JTextFieldNombre.getText().equals("")){
            ...
            int encontrada = tam.AgregarTamaño(nombre);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaTamaño.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
              public void run() {
                AltaTamaño dialog = new AltaTamaño(new javax.swing.JFrame(), true);
...
private void enlace() {
  ...
  GestionTamanos esp=new GestionTamanos(new javax.swing.JFrame(), true);
  esp.idrol=idrol; 
      try
        {
        cn=cm.Conectar();
        ...
        ResultSet rs = st.executeQuery(sql);
            while(rs.next())
            {                                
              L=rs.getInt("L_TAMAÑO");
              ES=rs.getInt("ESC_TAMAÑO");
