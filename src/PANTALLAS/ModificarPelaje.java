...
public class ModificarPelaje extends javax.swing.JDialog {
    Connection cn;
    ConexionMySQL cm=new ConexionMySQL();
    CallableStatement cmd;
    ClasePelaje pelaje=new ClasePelaje();
    public ModificarPelaje(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
    }

    @SuppressWarnings("unchecked")int idrol,IDPelaje;boolean bandera;
...
String razaSelec,coincidencia;int indice1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarPelaje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarPelaje dialog = new ModificarPelaje(new javax.swing.JFrame(), true);
