...
public class ModificarTamaño extends javax.swing.JDialog{
    Connection cn;
    ConexionMySQL cm=new ConexionMySQL();
    CallableStatement cmd;
    ClaseTamanos tam=new ClaseTamanos();
    public ModificarTamaño(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
int idrol,ID;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarTamaño.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
             public void run() {
                ModificarTamaño dialog = new ModificarTamaño(new javax.swing.JFrame(), true);
