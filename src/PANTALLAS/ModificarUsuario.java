...
public class ModificarUsuario extends javax.swing.JDialog {
    ...
    public ModificarUsuario(java.awt.Frame parent, boolean modal) {
        ...
        this.TextField_contraseña.setDocument(new JTextFieldToUpperCase());
        this.TextField_contraseña2.setDocument(new JTextFieldToUpperCase());
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jComboBox_Localidades, 0, 228, Short.MAX_VALUE)
                ...
                .addGroup(PanelUsuarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(PanelUsuarioLayout.createSequentialGroup()
                        ...
                        .addGroup(PanelUsuarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(TextField_contraseña, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE)
                            .addComponent(TextField_usuario)
                            .addComponent(comboTipoUsu, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(PanelUsuarioLayout.createSequentialGroup()
                        .addComponent(jLabel8)
                        .addGap(30, 30, 30)
                        .addComponent(TextField_contraseña2)))
                .addContainerGap())
        );
...
int idusuario,ROL;int idusu,idPersona;String usuario,contraseña,APELLIDO,NOMBRE,DIRECCION,EMAIL,LOCALIDAD,CODAREA,ROLSELEC;int NUMTELE; String seleccion,con,cont2,h;
    private void buttonActionGUARDARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionGUARDARActionPerformed
       if(TextField_contraseña2.getText().equals("") || TextField_usuario.getText().equals("") || TextField_contraseña.getText().equals("") ||apellido.getText().equals("") ||TextField_nom.getText().equals("")|| TextField_direccion.getText().equals("") || TextFieldnumero.getText().equals("")){
            ...
            String anterior,nuevo;int num;
            String cont2=TextField_contraseña2.getText();
            String nombreusuario = TextField_usuario.getText();
            String con = TextField_contraseña.getText();
            String a=apellido.getText();
            String N=TextField_nom.getText();
            String direc=TextField_direccion.getText();
            String cod=TextField_contraseña.getText();
            String correo=JTextFieldCorreo.getText();
            num=Integer.parseInt(TextFieldnumero.getText());

            nuevo="Usuario:"+nombreusuario+",Apellidos,Nombres:"+a+","+N+",Localidad:"+locSeleccionada+",Dirección:"+direc+"Teléfono:"+cod+"-"+num+",E-mail:"+correo;
            anterior="Usuario:"+usuario+",Apellidos,Nombres:"+APELLIDO+NOMBRE+",Localidad:"+LOCALIDAD+",Dirección:"+DIRECCION+"Teléfono:"+CODAREA+"-"+NUMTELE+",E-mail:"+EMAIL;
            BuscarUsuario();
            fecha();
            ...
            if(cod.equals(cont2)){
                ...
                claseusu.Modificar(idusu,a,N,nombreusuario, con,idtipo);
                persona.ModificarPersona(idPersona,direc, IDTIPOTELEFONO, num, ID_LOCALIDAD, correo, fechaActual, hor, usuario,"USUARIOS", anterior, nuevo);
...
//        jComboBox_Localidades.setSelectedItem("");
...
boolean banderaProvincia;
    private void jComboBoxProvinciasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxProvinciasActionPerformed
        seleccion =jComboBoxProvincias.getSelectedItem().toString();
        int indice=jComboBoxProvincias.getSelectedIndex();
    ...
    private void TextField_usuarioFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_TextField_usuarioFocusLost
        String nombreusuario=this.TextField_usuario.getText();
        int resultado=claseusu.BuscarCoincidencias(nombreusuario);
        if(resultado!=0){
            JOptionPane.showMessageDialog(null,"El Usuario Se Encuentra Registrado","Información",JOptionPane.INFORMATION_MESSAGE);
...
private void BuscarPrimerRol() {
   try {
        ...
        ResultSet rs = st.executeQuery("SELECT  MIN(idtipousuario)AS id FROM tipo_usuario");
 ...
 private void llenarcomboTipoUsu() {
        try {
  ...
  void fecha(){                                                                                                                                                                                                              
    ...
    f=new Date(Calendario.getTime().getYear(),Calendario.getTime().getMonth(),Calendario.getTime().getDay());
...
int ID_LOCALIDAD;String locSeleccionada;
    private void BuscarIDLocalidad(String localidad) {
        ...
        try {
             cn=cm.Conectar();
             Statement st=(Statement)cn.createStatement();
             ResultSet rs=st.executeQuery("SELECT codigo,localidades.id,nombre FROM localidades WHERE nombre LIKE '"+localidad+"%'");
             while(rs.next()){
                  COD_AREA=rs.getInt("codigo");
                  ID_LOCALIDAD=rs.getInt("id");
                  locSeleccionada=rs.getString("nombre");
                }
             this.TextFieldcodigo.setText(String.valueOf(COD_AREA));
             rs.close();             
        } catch (Exception ex) {
            ex.getMessage();
        }
 ...
 private void BuscarIDProvincia(String seleccion) {
      try {
        cn=cm.Conectar();
        Statement st = (Statement) cn.createStatement();
        ResultSet rs = st.executeQuery("SELECT id FROM provincia WHERE provincias.nombre LIKE '"+seleccion+"%'");
