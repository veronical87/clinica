...
public class ModificarAfeccion extends javax.swing.JDialog {
   ...
   Connection cn;
    ...
    public ModificarAfeccion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
     ...
     */
    @SuppressWarnings("unchecked")  int IDAfeccion,idrol;
    ...
    private void buttonActionGUARDARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionGUARDARActionPerformed
        if(JTextFieldNombre.getText().equals("")){
            ...
            afeccion.ModificarAfeccion(IDAfeccion,nombre);            
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarAfeccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
              public void run() {
                ModificarAfeccion dialog = new ModificarAfeccion(new javax.swing.JFrame(), true);
