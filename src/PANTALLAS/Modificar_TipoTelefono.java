...
public class Modificar_TipoTelefono extends javax.swing.JDialog {
    Connection cn;
    ConexionMySQL cm=new ConexionMySQL();
    CallableStatement cmd;
    ClaseTipoTelefono tipo=new ClaseTipoTelefono();
    public Modificar_TipoTelefono(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelRectTranslucido1, javax.swing.GroupLayout.PREFERRED_SIZE, 311, javax.swing.GroupLayout.PREFERRED_SIZE)
        );

        pack();
    }// </editor-fold>//GEN-END:initComponents
int IDUSUARIO,IDROL,IDTIPO;
    ...
    if(nom.getText().equals("")){
            ...
            String existe=tipo.BuscarCoincidencias(nombre);
            if(existe==null){               
                tipo.ModificarTipoTelefono(IDTIPO,nombre);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modificar_TipoTelefono.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Modificar_TipoTelefono dialog = new Modificar_TipoTelefono(new javax.swing.JFrame(), true);
